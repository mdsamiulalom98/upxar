                        ...
                        <form action="{{ route('products.update') }}" method="POST" class="row" data-parsley-validate=""
                            ...
                            <div class="col-sm-3">
                                <div class="form-group mb-3">
                                    ...
                                    <option value="male" {{ $edit_data->gender == 'female' ? 'selected' : '' }}>Female
                                    </option>
                                    <option value="others" {{ $edit_data->gender == 'others' ? 'selected' : '' }}>Others
                                    </option>
                                    </select>
                                    @error('gender')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="meta_keyword" rows="4" class="form-control @error('meta_keyword') is-invalid @enderror">{{ $edit_data->meta_keyword }}</textarea>
                                    @error('meta_keyword')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
