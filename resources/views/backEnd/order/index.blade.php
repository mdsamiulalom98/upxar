            ...
            <div class="card-body">
                ...
                <table id="datatable-buttons" class="table  w-100">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $value->emi_amount > 0 ? 'table-primary' : '' }}">
                            ...
                            <td>
                                <div class="button-list custom-btn-list">
                                    ...
                                    @if ($value->emi_amount)
                                    <a href="{{route('admin.order.installments',['invoice_id'=>$value->invoice_id])}}" title="Edit"><i class="fe-credit-card"></i></a>
                                    @endif
                            ...
                            <td>{{$value->invoice_id}}<br> {{$value->customer_ip}} <br>@if($value->order_type == 'digital') <i class="fa fa-gift"></i> @endif</td>
                            ...
                            <td>৳{{$value->amount}}
                                @if ($value->emi_amount > 0)
                                <br>
                               Due: ৳{{ $value->emi_amount - $value->down_payment }}
                                @endif
                            </td>
