        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('colors.create')}}" class="btn btn-primary rounded-pill">Create</a>
                </div>
                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="btn " style="background-color: #fff; color: #000;border: 6px solid;border-color: {{ $value->color }};">{{ $value->name }}</span></td>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <a href="{{route('colors.edit',$value->id)}}" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
