        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('childcategories.update')}}" method="POST" class="row" data-parsley-validate="" name="editForm"  enctype="multipart/form-data">
                                ...
                                <optgroup >
                                    ...
                                    <option value="">==== {{ $category->name }} == ==</option>
                                        @foreach ($category->subcategories as $subcat)
                                            <option value="{{ $subcat->id }}" @if($subcat->id == $edit_data->subcategory_id) selected @endif >{{ $subcat->name }}</option>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="name" class="form-label">Childcategory Name *</label>
