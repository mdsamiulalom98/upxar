                    ...
                    <input type="hidden" name="id" value="{{$data->id}}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select id="district"
                                        ...
                                        @foreach ($districts as $key => $value)
                                            <option value="{{ $value->district }}" {{$data->shipping->district == $value->district ? 'selected' :''}}>
                                    ...
                                    <select id="area"
                                        ...
                                        name="area" value="{{ old('area') }}" required>
                                         @foreach ($areas as $key => $value)
                                            <option value="{{ $value->id }}" {{$data->shipping->area == $value->area_name ? 'selected' :''}}>
                            ...
                            <div class="col-sm-6">
                              <div class="form-group mb-3">
                                   ...
                                   <input type="number" class="form-control @error('advance') is-invalid @enderror" name="advance" id="advance" value="{{$data->advance}}" placeholder="Advance Payment">
                                     @error('advance')
                                      <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                      </span>
