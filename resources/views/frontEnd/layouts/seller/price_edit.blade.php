...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{ route('seller.products.price_update') }}" method="POST">
                        @csrf
                        <div class="card-body">
                                ...
                                <table class="table nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:50%">Name - Size / Color</th>
                                    ...
                                    <tbody>
                                        @foreach ($products as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->product->name ?? "Product" }} <br> <span class="btn btn-blue">{{ $value->size }}</span> <span class="btn btn-pink">{{ $value->color }}</span></td>
