                        ...
                        <form action="{{ route('seller.products.store') }}" method="POST" class="row"
                            ...
                            <div class="col-sm-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" maxlength="11" class="form-control @error('weight') is-invalid @enderror"
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="meta_keyword" rows="4" class="form-control @error('meta_keyword') is-invalid @enderror"></textarea>
                                    @error('meta_keyword')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
