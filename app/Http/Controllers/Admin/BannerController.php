...
class BannerController extends Controller
{
    ...
    {
        $categoriese = BannerCategory::orderBy('id','DESC')->select('id','name')->get();
        // return   $categoriese;
        return view('backEnd.banner.create',compact('categoriese'));
    }
    ...
    public function edit($id)
    {
        ...
        $categoriese = BannerCategory::select('id','name')->get();
        // return $categoriese;
        return view('backEnd.banner.edit',compact('edit_data','categoriese'));
    }
